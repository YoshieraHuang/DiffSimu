...
colors = (None, 'b', 'g', 'r', 'c', 'm', 'y', 'k', 'w', '#acc2d9','#56ae57', '#b2996e', '#a8ff04', '#69d84f', '#894585', '#70b23f', '#d4ffff', '#952e8f', '#fcfc81', '#a5a391',
  '#388004', '#4c9085', '#5e9b8a', '#efb435')

dict_material = {
	'Cu' : ('fcc', (3.615, 'Cu')),
  'Ta' : ('bcc', (3.304, 'Ta')),
  'Al' : ('fcc', (4.406, 'Al')),
  'Mg' : ('hcp', (3.2094, 5.2105,'Mg')),
  'Si' : ('diamond', (5.4305, 'Si'))
}
...
dict_structure = {
  ...
  'hcp' : (('$a', '$a', '$c', 90, 90, 120), (2, ('$elem', (0,0,0)), ('$elem', (1/3, 2/3, 0.5)))),
  'diamond' : (('$a', '$a', '$a', 90, 90, 90), (8, ('$elem', (0,0,0)), ('$elem', (0.5,0.5,0)), ('$elem', (0.5,0,0.5)), ('$elem', (0,0.5,0.5)), ('$elem', (1/4,1/4,1/4)), ('$elem', (1/4,3/4,3/4)), ('$elem', (3/4,1/4,3/4)), ('$elem', (3/4,3/4,1/4)))),
}
